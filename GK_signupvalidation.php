...
// DATABASE CONNECTION
require("GK_dbConnection.php");

// types of error stored according to names and displayed
$nameErr = $emailErr = $phonenoErr = $dobErr = $otherinfoErr = $passwordErr = $termsErr = "";
// storing values so not to lose during reload
$name = $email = $phoneno = $dob = $otherinfo = $password = $terms = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($nameErr === "" && $emailErr === "" && $phonenoErr === "" && $dobErr === "" && $otherinfoErr === "" && $passwordErr === "" && $termsErr === "") {
        ...
        if($result){
            ...
            header("Location: GK_successfulregistration.php");
        }
    }
}
